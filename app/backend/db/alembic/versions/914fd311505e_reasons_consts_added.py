...
def upgrade():
    ...
    op.alter_column('date_details', 'type',
               existing_type=postgresql.ENUM('required', 'not_required', 'not_important', name='date_type'),
               type_=sa.Enum('required', 'not_required', 'unknown', name='date_type'),
...
def downgrade():
    ...
    op.alter_column('date_details', 'type',
               existing_type=sa.Enum('required', 'not_required', 'unknown', name='date_type'),
               type_=postgresql.ENUM('required', 'not_required', 'not_important', name='date_type'),
               existing_nullable=True)
